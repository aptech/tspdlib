...
The `tspdlib` library is written for GAUSS by [Saban Nazlioglu](mailto:snazlioglu@pau.edu.tr), Department of International Trade & Finance, Pamukkale University-TÃ¼rkiye.
...
|Procedure| Reference|Description|
|:------:|:---------|:------------|
|[`adf`](https://docs.aptech.com/gauss/tspdlib/docs/adftspd.html)| [Dickey, D.A., Fuller, W.A. (1979)](https://www.jstor.org/stable/2286348?seq=1#page_scan_tab_contents). Distribution of the estimators for autoregressive time series with a unit root. Journal of the American Statistical Society75, 427â€“431.| ADF unit root test.|
...
|[`kpss_2br`](https://docs.aptech.com/gauss/tspdlib/docs/kpss_2break.html)|[Carrion-i-Silvestre, J. Ll. & SansÃ³, A. (2007)](https://www.researchgate.net/publication/24064952_The_KPSS_test_with_two_structural_breaks). The KPSS test with two structural breaks. Spanish Economic Review, 9, 2, 105-127.|KPSS test for stationarity with two structural breaks.|
...
|[`qks_tests`](https://docs.aptech.com/gauss/tspdlib/docs/qr_qks.html)|[Bahmaniâ-Oskooee, M., Chang, T., Niroomand, F., & Ranjbar, O. (2020)](https://doi.org/10.1111/boer.12230). Fourier nonlinear quantile unit root test and PPP in Africa. Bulletin of Economic Research, 72(4), 451-481.| Quantile Kolmogorov-Smirnov (QKS) tests|
...
|[`sbur_gls`](https://docs.aptech.com/gauss/tspdlib/docs/sbur_gls.html)|[Carrion-i-Silvestre, J. L., Kim, D., & Perron, P. (2009)](https://www.jstor.org/stable/40388611). GLS-based unit root tests with multiple structural breaks under both the null and the alternative hypotheses. Econometric theory, 25(6), 1754-1792.|Estimates the structural breaks in a GLS-detrended framework.|
...
|[`pdfzk`](https://docs.aptech.com/gauss/tspdlib/docs/pdfzk.html)|[Nazlioglu, S., & Karul, C. (2017)](https://econpapers.repec.org/article/eeeecmode/v_3a61_3ay_3a2017_3ai_3ac_3ap_3a181-192.htm). A panel stationarity test with gradual structural shifts: Re-investigate the international commodity price shocks. Economic Modelling, 61, 181-192.|Computes the panel stationary test with flexible Fourier form structural breaks.|
|[`pd_iltlevel`](https://docs.aptech.com/gauss/tspdlib/docs/pdlm.html)|[Im, K., Lee, J., Tieslau, M. (2005)](https://pdfs.semanticscholar.org/794e/035e2af830b66f5d229cd444cbc8b34c3d83.pdf). Panel LM Unit-root Tests with Level Shifts, Oxford Bulletin of Economics and Statistics 67, 393â€“419.|Panel data LM unit root test with structural breaks in the level.|
|[`pd_kpss`](https://docs.aptech.com/gauss/tspdlib/docs/pd_kpss.html)|[Carrion-i-Silvestre, J. L., del Barrio-Castro, T., & López-Bazo, E. (2005)](http://www.jstor.org/stable/23113636). Breaking the panels: An application to the GDP per capita.The Econometrics Journal, 8(2), 159–175.|Panel data KPSS test.|
...
|Procedure| Reference|Description|
|:------:|:---------|:-----------|
|[`asymcause`](https://docs.aptech.com/gauss/tspdlib/docs/asymcause.html)|[Abdulnasser Hatemi-J (2012).](https://doi.org/10.1007/s00181-011-0484-x) Asymmetric causality tests with an application. Empirical Economics 43, 447-456.|Performs the asymmetric causality tests of the hypothesis that z does not cause y. Based on original code provided by Abdulnasser Hatemi-J.|
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Granger, C.W.J. (1969).](https://www.jstor.org/stable/1912791) Investigating causal relations by econometric models and cross-spectral methods. Econometrica 37, 424â€“438.|Computes the tests for Granger causality of specified variables.|
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Granger, C.W.J. (1969).](https://www.jstor.org/stable/1912791) Investigating causal relations by econometric models and cross-spectral methods. Econometrica 37, 424â€“438.|Granger causality tests.|
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Toda, H.Y. & Yamamoto, T. (1995).](https://econpapers.repec.org/article/eeeeconom/v_3a66_3ay_3a1995_3ai_3a1-2_3ap_3a225-250.htm) Statistical inference in vector autoregression with possibly integrated processes. Journal of Econometrics 66,225-250.|Tests on the general restrictions on the VAR parameter matrices even if the processes may be integrated or cointegrated of an arbitrary order.|
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Enders, W., & P. Jones. (2016).](https://ideas.repec.org/a/bpj/sndecm/v20y2016i4p399-419n3.html) Grain prices, oil prices, and multiple smooth breaks in a var. Studies in Nonlinear Dynamics & Econometrics 20 (4):399-419.| Flexible Fourier form testing for smooth structural change in a VAR.|
...
|[`panel_SURwald`](https://docs.aptech.com/gauss/tspdlib/docs/panel_surwald.html)|[Kar, M., Nazlioglu, S., Agir, H. (2011).](https://doi.org/10.1016/j.econmod.2010.05.015) Financial Development and Economic Growth Nexus in the MENA Countries: Bootstrap Panel Granger Causality Analysis. Economic Modelling 28(1-2): 685-693.|Panel data Granger causality approach based on SUR systems and Wald tests with country specific bootstrap critical values.|
...
|[`pd_coint_wedgerton`](https://docs.aptech.com/gauss/tspdlib/docs/pd_coint_wedgerton.html)|[Westerlund, J. and Edgerton, D.L. (2008).](https://doi.org/10.1111/j.1468-0084.2008.00513.x) A Simple Test for Cointegration in Dependent Panels with Structural Breaks. Oxford Bulletin of Economics and Statistics, 70, 665-704.|Westerlund-Edgerton test of the null hypothesis of cointegration allowing for the possibility structural breaks.|

### Cross-Section Dependency Tests
|Procedure| Reference|Description|
|:------:|:---------|:----------|
|[`pd_getcderror`](https://docs.aptech.com/gauss/tspdlib/docs/pd_getcderror.html#pd_getcderror)|[Pesaran, M.H. (2020).](https://doi.org/10.1007/s00181-020-01875-7) General diagnostic tests for cross-sectional dependence in panels. Empirical Economics, 60, 13-50. |Computes error cross-section dependecy tests.|
