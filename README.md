...
|[`pd_kpss`](https://docs.aptech.com/gauss/tspdlib/docs/pd_kpss.html)|[Carrion-i-Silvestre, J. L., del Barrio-Castro, T., & L�pez-Bazo, E. (2005)](http://www.jstor.org/stable/23113636). Breaking the panels: An application to the GDP per capita.The Econometrics Journal, 8(2), 159�175.|Panel data KPSS test.|
...
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Granger, C.W.J. (1969).](https://www.jstor.org/stable/1912791) Investigating causal relations by econometric models and cross-spectral methods. Econometrica 37, 424–438.|Computes the tests for Granger causality of specified variables.|
|[`granger`](https://docs.aptech.com/gauss/tspdlib/docs/granger.html)|[Granger, C.W.J. (1969).](https://www.jstor.org/stable/1912791) Investigating causal relations by econometric models and cross-spectral methods. Econometrica 37, 424–438.|Granger causality tests.|
